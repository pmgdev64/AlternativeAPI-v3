...
import fr.trxyy.alternative.alternative_authv3.microsoft.MicrosoftAuth;
import fr.trxyy.alternative.alternative_authv3.microsoft.ParamType;
 ...
 * @author Trxyy
 */
public class GameAuth extends Logger{
	/**
	 * Is player authed ?
	 */
